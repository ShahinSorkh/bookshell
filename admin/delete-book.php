...
if (mysqli_num_rows($result) < 1) {
    redirect('admin.php?page=list-books', 'موردی یافت نشد', 'danger');
}
...
if (mysqli_query($db, "delete from books where id=$book[id] limit 1")) {
    ...
    redirect('admin.php?page=list-books', 'کتاب با موفقیت حذف شد', 'success');
} else {
    redirect('admin.php?page=list-books', 'could not delete: '.mysqli_error($db), 'danger');
}
